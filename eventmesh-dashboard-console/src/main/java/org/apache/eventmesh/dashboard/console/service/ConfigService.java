...
public interface ConfigService {
    ...
    ConfigEntity insertConfig(ConfigEntity config);

    ConfigEntity updateOneConfig(ConfigEntity config);

    ConfigEntity updateAllConfig(ConfigEntity config);

    ConfigEntity deleteConfig(ConfigEntity config);
}
